 ...
 * base API client.
 * 
 * Requirements: 7.2 - Multi-platform support for web frontend
 */
 ...
 * 
 * Requirements:
 * - 7.2: Provide budget creation functionality in web frontend
 ...
 * 
 * Requirements:
 * - 7.2: Provide budget viewing functionality in web frontend
 ...
 * 
 * Requirements:
 * - 7.2: Provide budget editing functionality in web frontend
 ...
 * 
 * Requirements:
 * - 7.2: Provide budget management functionality in web frontend
 ...
 * 
 * Requirements:
 * - 7.2: Provide alert configuration functionality in web frontend
...
export async function configureAlerts(budgetId: number, alerts: AlertConfig[]): Promise<void> {
  await apiClient.post(`/budgets/${budgetId}/alerts`, { alerts });
}
 ...
 * 
 * Requirements:
 * - 7.2: Provide alert editing functionality in web frontend
 ...
 * 
 * Requirements:
 * - 7.2: Provide alert management functionality in web frontend
 * 
 * @param alertId - Alert ID
 */
 ...
 * 
 * Requirements:
 * - 7.2: Provide budget status viewing functionality in web frontend
 * - 5.2: Display budget with category, amount, period, status
 * - 5.3: Show current spending amount and percentage used
 * 
 * @param id - Budget ID
 ...
 * 
 * Requirements:
 * - 7.2: Provide budget history viewing functionality in web frontend
...
export async function getBudgetHistory(id: number): Promise<BudgetHistory[]> {
  const response = await apiClient.get(`/budgets/${id}/history`);
  return response.data.data || response.data;
}
